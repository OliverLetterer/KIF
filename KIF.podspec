Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/OliverLetterer/KIF.git", :tag => "2.0.0.1" }
  s.platform     = :ios, '4.3'
  ...
  s.subspec 'Core' do |core|
	...
	core.xcconfig = { 'OTHER_CFLAGS' => '-DKIF_XCTEST' }
    core.source_files = 'Classes', 'Additions'
    core.public_header_files = 'Classes/**/*.h', 'Additions/**/*-KIFAdditions.h'
    core.exclude_files = 'Additions/SenTestCase-KIFAdditions.{h,m}'
  end
end
